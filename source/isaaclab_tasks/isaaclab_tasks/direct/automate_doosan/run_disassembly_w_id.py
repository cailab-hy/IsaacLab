...
def main():
    ...
    default_disassembly_dir = current_dir + '/data'
    # ------------------------------------------------------------------------------------------
    ...
    parser.add_argument(
        ...
        default=f"{default_disassembly_dir}",
    )
    parser.add_argument(
        "--cfg_path",
        type=str,
        help="Path to the file containing assembly_id.",
        default="source/isaaclab_tasks/isaaclab_tasks/direct/automate_doosan/disassembly_tasks_cfg.py",
    )
    ...
    bash_command += " scripts/reinforcement_learning/rl_games/train.py --task=Isaac-AutoMate-Disassembly-Doosan-Direct-v0"
